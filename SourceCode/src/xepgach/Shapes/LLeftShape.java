...
public class LLeftShape extends Shape{
    ...
    public void init(){
        ...
        m_block3.setPosition(new Vector(GBlock.getActualWidth(), GBlock.getActualHeight() * 2));
    ...
    public void setRotationValue(int val){
        ...
        m_block4.setPosition(new Vector(GBlock.getActualWidth(), 0)); 
