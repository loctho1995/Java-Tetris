...
public class LRightShape extends Shape{
    ...
    public void setRotationValue(int val){
        ...
        m_block1.setPosition(new Vector(0, GBlock.getActualHeight()));
        m_block2.setPosition(new Vector(GBlock.getActualWidth(), GBlock.getActualHeight()));
        m_block3.setPosition(new Vector(GBlock.getActualWidth() * 2, GBlock.getActualHeight()));
        m_block4.setPosition(new Vector(GBlock.getActualWidth() * 2, 0)); 
        ...
        m_block4.setPosition(new Vector(0, GBlock.getActualHeight())); 
